...
def build_save_dataset(corpus_type, fields, src_reader, tgt_reader,
    ...
    print("preprocess.py > build_save_dataset")
    if corpus_type == 'train':
    ...
    def shard_iterator(srcs, tgts, ids, aligns, existing_shards,
        ...
        print("preprocess.py > build_save_dataset > shard_iterator END")

    print(">build_save_dataset.3")
    shard_iter = shard_iterator(srcs, tgts, ids, aligns, existing_shards,
                                existing_fields, corpus_type, opt)
    print(">build_save_dataset.4")
...
def build_save_vocab(train_dataset, fields, opt):
    print("preprocess.py > build_save_vocab")
...
def preprocess(opt):
    ...
    print("preprocess.py > preprocess")
