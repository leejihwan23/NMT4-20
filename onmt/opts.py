...
def model_opts(parser):
    ...
    group.add('--heads', '-heads', type=int, default=10,
...
def preprocess_opts(parser):
    ...
    group.add('--src_vocab_size', '-src_vocab_size', type=int, default=32000,#32000
              help="Size of the source vocabulary")
    group.add('--tgt_vocab_size', '-tgt_vocab_size', type=int, default=32000,#32000
...
def train_opts(parser):
    ...
    group.add('--train_steps', '-train_steps', type=int, default=5000,
